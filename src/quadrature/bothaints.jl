...
function BothaTriangle(vertices, normal::SVector{3,T}) where T
    ...
    yrange = (T(0.0), dot(vertices[3] - vertices[1], ey))
...
#TODO: check hte following rules as they dont work yet
...
# rescales the quadrature points and weights to the interval [a,b]
...
#creates the three botha triangles
